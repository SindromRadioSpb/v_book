...
def test_load_items_increments_request_id(monkeypatch):
    ...
    monkeypatch.setattr("app.ui.user_dictionaries_view.UserDictItemsPageWorker", _FakeWorker)
    ...
    monkeypatch.setattr("app.ui.user_dictionaries_view.UserDictItemsPageWorker", _FakeWorker2)
