...
> Version: 1.8 (updated 2026-03-26: C03 v2 completed — hapax, all-doc lemma, empty doc, stress, all-empty; parametrized invariants; count 223→247)
...
```
Expected: **247 passed, 0 failed** (as of C03 Wave 2, 2026-03-26).
