...
class TermExtractionProgressDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        self.setWindowTitle("Term Extraction")
        ...
        self.status_label = QLabel("Preparing staged extraction...")
    ...
    def update_state(self, state: dict) -> None:
        ...
        if phase in {"finalize", "completed", "cancelled"}:
    ...
    def on_cancel(self) -> None:
        ...
        self.pause_btn.setEnabled(False)
        self.status_label.setText("Cancelling after current checkpoint...")
